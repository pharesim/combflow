...
async function init() {
  ...
  // /@author/permlink loads, where the SPA renders its own live equivalents —
  // the comment tree (095) and the modal author card (099) — so removing the
  // static copy avoids duplicate content (proposal 095 risk #1, Option A).
